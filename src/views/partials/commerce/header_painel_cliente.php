...
$notifi = $not->listanotificacoesCli();
if($notifi == 0){
  $qtdNoti = 0;
}else{
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <?php if($notifi != 0): ?>
            ...
            <?php endif; ?>
          <div class="dropdown-divider"></div>
          <a href="#" class="readall dropdown-item dropdown-footer">Marcar todas como lida</a>
        </div>
      </li>
      <li class="nav-item">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="/cliente/painel" class="d-block"><?php echo $_SESSION['log_admin_c']['nome']; ?></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-is-opening menu-open">
            ...
            <ul class="nav nav-treeview" style="display: none;">
              <li class="nav-item">
                <a href="/cliente/painel/questionario" class="nav-link">

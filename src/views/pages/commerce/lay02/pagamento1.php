...
<section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('<?php echo BASE_ASS_C; ?>lay02/images/cardban.jpg');">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <form action="/pagamento/action/0" method="POST">
                ...
                <input type="text" class="form-control" name="numero" id="numero" name="numero"
                ...
                <input type="text" class="form-control" name="complemento" id="formGroupExampleInput"
        ...
        <div class="col-md-7">
            ...
            <form id="frete">
                ...
                <input type="text" class="form-control" id="cepCalc" name="cepCalc"

...
$('#3').on('click',function(){
    ...
    $.ajax({
        url: '/crie-sua-loja/pagamento/boleto/checkout/3',
        type: 'GET',
        dataType: 'JSON',
        beforeSend: function(){
            $('#loading3').html('<div class="d-flex justify-content-center"><div class="spinner-border" role="status"></div><span class="visually-hidden"> &nbsp;&nbsp; Aguarde...</span></div><br>');
        },
